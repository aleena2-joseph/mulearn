...
const Hero = forwardRef((props, ref) => {
  ...
  useEffect(() => {
    ...
    window.addEventListener("scroll", handleScroll);
    handleScroll(); // Call immediately to check initial state
    return () => window.removeEventListener("scroll", handleScroll);
  }, [sectionRef]);
  ...
  return (
    <>
      ...
      <section
        id="hero-section"
        ref={sectionRef}
        className="relative min-h-screen bg-white overflow-hidden transition-opacity duration-500"
        style={{ opacity: isVisible ? 1 : 0 }} // Use inline style for immediate effect
      >
        <div className="absolute inset-0 mesh-gradient">
          <div
            ref={orb1Ref}
          ...
          <div className="container mx-auto px-8 py-12">
            ...
            <div className="grid lg:grid-cols-2 gap-12 mb-20 animate-slide-left">
              <div className="glass-morphism p-8 rounded-3xl advanced-shadow">
                <div className="flex items-start gap-6 mb-6">
                  <svg
                    className="w-10 h-10 text-violet-600 flex-shrink-0"
                    fill="none"
                    stroke="currentColor"
                    viewBox="0 0 24 24"
                  >
              ...
              <div className="glass-morphism p-8 rounded-3xl advanced-shadow">
                <div className="flex items-start gap-6 mb-6">
                  <svg
                    className="w-10 h-10 text-indigo-600 flex-shrink-0"
                    fill="none"
                    stroke="currentColor"
                    viewBox="0 0 24 24"
                  >
              ...
              <div className="glass-morphism p-8 rounded-3xl advanced-shadow">
                <div className="flex items-start gap-6 mb-6">
                  <svg
                    className="w-10 h-10 text-fuchsia-600 flex-shrink-0"
                    fill="none"
                    stroke="currentColor"
                    viewBox="0 0 24 24"
                  >
